          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-800">Robert Johnson</h4>
                  <p className="text-gray-600">Stone Works Inc.</p>
                </div>
              </div>
              <div className="mb-4">
              ...
              <p className="text-gray-600 italic">
                "The stone cutting machinery we purchased has significantly improved our production efficiency. The
                quality and precision are unmatched, and the support team has been exceptional."
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-gray-300 mr-4"></div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-800">Sarah Martinez</h4>
                  <p className="text-gray-600">Architectural Designs Co.</p>
                </div>
              </div>
              <div className="mb-4">
                <div className="flex text-yellow-400">
              ...
              <p className="text-gray-600 italic">
                "As designers, we need tools that can execute our vision with precision. The cutting tools we've
                purchased have allowed us to create intricate stone details that were previously impossible."
              </p>
            </div>
          </div>
        </div>
